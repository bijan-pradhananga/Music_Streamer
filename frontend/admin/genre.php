...
<div class="popup<?php echo isset($_GET['id']) ? ' active' : ''; ?>">
    ...
    <div class="content">
        <a href="genre.php"><div class="close-btn" id="close-btn" onclick="togglePopup(event)">&times;</div></a>
        <br>
        <div class="main-popup-content" >
            ...
            <form  action="" id="registerForm" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="Genre_Name" placeholder="Enter Your Genre Name" value="<?= isset($_GET['id']) ? $edit[0]['Genre_Name'] : '' ?>"><br>
